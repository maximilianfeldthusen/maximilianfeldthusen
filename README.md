...
C/C++ Development
I specialize in system programming, embedded systems, and performance-critical applications using C and C++. 
...
<!-- BLOG-POST-LIST:START -->
- [Posts Github](https://github.com/maximilianfeldthusen/)
<!-- BLOG-POST-LIST:END -->
